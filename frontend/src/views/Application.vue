<!-- <template>
  ...
  try {
    ...
    // const response = await axios.get("http://127.0.0.1:5000/dashboard", {
    const response = await axios.get("https://kvqa-auditor-data-management.onrender.com/dashboard", {
      headers: {
    ...
    try {
        ...
        // await axios.delete(`http://127.0.0.1:5000/dashboard/${id}`, {
        await axios.delete(`https://kvqa-auditor-data-management.onrender.com/dashboard/${id}`, {
            headers: {
...
async searchApplications() {
      try {
        ...
        const response = await axios.get("https://kvqa-auditor-data-management.onrender.com/search", {
